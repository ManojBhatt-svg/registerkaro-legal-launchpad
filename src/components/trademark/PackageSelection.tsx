            ...
            >
              ...
              >
                <div className="relative h-full flex flex-col">
                  ...
                  <CardHeader className={`flex flex-col items-center text-center ${pkg.recommended ? 'pt-14' : 'pt-8'}`}>
                    <div className={`h-20 w-20 rounded-full flex items-center justify-center mb-4 ${
                      ...
                      {pkg.icon && <pkg.icon className="h-10 w-10" />}
                    </div>
                    ...
                    <p className="text-gray-500 mt-1 text-lg">{pkg.description}</p>
